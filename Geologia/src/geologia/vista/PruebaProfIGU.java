...
public class PruebaProfIGU extends JInternalFrame {
    ...
    private void addBxVerticalPrincipal() {
        ...
        addPanelTabla();	//agrega panel de tabl
    ...
    public void setTabla() {
        ...
        Object datos[][] = ProfesorDAO.filtrarProfesor("Hugo");					//obtiene todos los datos de la base de datos
        ...
        tblLista.getColumnModel().getColumn(1).setPreferredWidth(184);
        tblLista.getColumnModel().getColumn(2).setPreferredWidth(80);
        tblLista.getColumnModel().getColumn(3).setPreferredWidth(50);
