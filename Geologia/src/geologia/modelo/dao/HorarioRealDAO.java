...
public class HorarioRealDAO {
	...
	public static boolean insertar(HorarioReal horario){
		int constraint;
                String query;
		boolean access = true;
		...
		try{
			...
			query = "INSERT INTO HorarioReal(idHorario,horaEntrada,horaSalida,dias) VALUES (?, ?, ?, ?);";
                        sentencia = conexion.prepareStatement(query);
                        
                        sentencia.setInt(1,horario.getIdHorarioR());
			sentencia.setFloat(2,horario.getHoraEnrtada());
        		sentencia.setFloat(3,horario.getHoraSalida());
			sentencia.setInt(4,horario.getDias());
 ...
 //*************ACTUALIZAR****************
	...
	public static boolean actualizar(HorarioReal horario){
		int constraint;
		boolean access = true;
